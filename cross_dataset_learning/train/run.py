...
parser.add_argument('--test_metrics_path', type=str, default='main/cross_dataset_learning/train')
parser.add_argument('--outdir_base', type=str,default='main/cross_dataset_learning/train')
...
def run():
    ...
    if accelerator.is_main_process:
        with open(test_metrics_path, "a") as f:
            f.write(f"{name}\n")
    model_train(dataset_tr,dataset_va,dataset_te,name,test_metrics_path)
